...
For `0.8.0+`, read-heavy profiles should be run against leader or standalone nodes when
...
latency under the server's configured write acknowledgement mode. On `0.8.0+`, this
